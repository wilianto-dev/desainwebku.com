...
export default function CreatePortfolio() {
  ...
  return (
    <AuthenticatedLayout title="Tambah Portofolio">
      <Head title="Tambah Portofolio" />

      {/* Header */}
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Tambah Portofolio Baru</h1>
          <p className="text-gray-600 mt-1">Tambahkan karya terbaru ke portofolio</p>
        </div>
        <Link
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Deskripsikan proyek secara detail: latar belakang, tantangan, solusi, hasil..."
              />
              {errors.description && (
                <p className="mt-1 text-sm text-red-600 flex items-center">
                  <ExclamationCircleIcon className="h-4 w-4 mr-1" />
            ...
            <div>
              ...
              {imagePreview ? (
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-500 text-sm">PNG, JPG, GIF up to 2MB</p>
                  <input
                    type="file"
                    id="image"
