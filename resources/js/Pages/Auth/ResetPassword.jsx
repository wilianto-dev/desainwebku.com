...
export default function ResetPassword({ token, email }) {
  ...
  const getThemeContent = () => {
    switch (theme) {
      case 'cyber':
        return {
          title: 'RESET_CREDENTIALS',
          subtitle: 'Create new password',
          emailLabel: 'REGISTERED_EMAIL',
          passwordLabel: 'NEW_PASSWORD',
          confirmLabel: 'CONFIRM_NEW_PASSWORD',
          button: '$ UPDATE_CREDENTIALS',
      ...
      case 'dark-corporate':
        return {
          title: 'RESET PASSWORD',
          subtitle: 'Enterprise credential update',
  ...
  return (
    <AppLayout title="Reset Password - Desainwebku">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <TextInput
                      ...
                      name="email"
                      value={data.email}
                      className="pl-10 block w-full bg-[var(--color-bg-secondary)]"
